...
class LandingRoyal extends StatefulWidget {
  const LandingRoyal({super.key});

  @override
  State<LandingRoyal> createState() => _LandingRoyalState();
}

class _LandingRoyalState extends State<LandingRoyal>
